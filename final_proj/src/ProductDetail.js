        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins&family=Port+Lligat+Slab"></link>
            <div className="product-detail-page">
                ...
                <div className="breadcrumbs">
                    <NavLink to='/products' id="breadcrumbs-menu" class="child" data-testid='breadcrumbs-menu'>Menu</NavLink>
                    <div className="child" id="arrow">{'>'}</div>
                    <div id="breadcrumbs-prod-details" className="child" data-testid='breadcrumbs-prod-details'>Product Details</div>
                </div>
